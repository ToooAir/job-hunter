...
Two passes (Step 4 design, approved 2026-06-12):
  ...
  Pass B (LLM, no browser): run the per-job pipeline (apply_graph.run_apply)
  — reuse the scored cover letter, verify, assign tier, save a draft
  snapshot. (The field-mapping chain was retired 2026-07-02 — facts are
  filled live at apply time by the extension's /fill-plan; the extracted
  field table now only feeds the weak-form verdict.)
